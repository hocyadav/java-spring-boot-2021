...
public class Lec02OverlapAndDrop {
    ...
    public static void main(String[] args) {
        //use case 1 (overlap): check for some patterns in events (required windows size data, so subsequence group need to know info about each other)
        //use case 2 (drop): sampling of events (only required few events/data)
